...
CURRICULUM_LIBRARY_FILE   = "data/curriculum_library.json"
CURRICULUM_DOCUMENTS_FILE = "data/curriculum_documents.json"
STUDENT_SUBMISSIONS_FILE  = "data/student_submissions.json"
GRADING_QUEUE_FILE       = "data/grading_queue.json"
GRADING_HISTORY_FILE     = "data/grading_history.json"
