...
def build_coach_context(iso: str, weekday: str, date_label: str) -> str:
    ...
    lines += [
        ...
        "",
        "== POINTING LAUREN TO THE PROGRAMS PAGE ==",
        ...
        "LINK to the Programs page in your reply. Do not just describe the",
        "navigation; give her a clickable link.",
        "",
        "Link formats (use markdown link syntax exactly):",
        "- Whole page:        [View your Programs page](/programs)",
        "- A specific person: [Lauren's programs](/programs?focus=Lauren)",
